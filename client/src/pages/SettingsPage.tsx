  ...
  return (
    <>
      ...
      <div className="flex min-h-0 w-full flex-1 gap-6 xl:gap-7">
        <div className="w-[248px] shrink-0"><SidebarWrapper>
          <SidebarItem
            active={activeSection === 'pipeline'}
            icon="tabler:player-play"
            label="Select stages and launch"
            namespace={false}
        ...
        <div className="relative z-10 flex h-full min-w-0 flex-1 flex-col gap-6">
          <div ref={pipelineRef}>
            <Card className="space-y-6 border border-bg-500/10 bg-component-bg/80 p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  <p className="mb-3 text-sm font-semibold">Stages</p>
                ...
                <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                  {([
                    ...
                    <Card key={item.id} className="space-y-3 border border-bg-500/10 bg-component-bg-lighter/50 p-4 shadow-none">
                      <div className="space-y-1">
                        <p className="text-sm font-semibold">{item.label}</p>
                        <p className="text-xs text-bg-500">{item.desc}</p>
                      </div>
                      <TextInput placeholder="08:00" value={item.time} variant="plain" onChange={item.setTime} />
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-medium text-bg-500">Enabled</span>
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                  <Card className="border border-bg-500/10 bg-component-bg-lighter/50 p-4 shadow-none">
                  ...
                  <Card className="border border-bg-500/10 bg-component-bg-lighter/50 p-4 shadow-none sm:col-span-2">
